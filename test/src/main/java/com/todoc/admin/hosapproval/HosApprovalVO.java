...
public class HosApprovalVO {
	...
	public String toString() {
		return "HosApprovalVO [hosIdx=" + hosIdx + ", hosId=" + hosId + ", hosPw=" + hosPw + ", hosName=" + hosName
				...
				+ sido + ", sigungu=" + sigungu + ", searchCondition=" + searchCondition + ", beginDate=" + beginDate
				+ ", endDate=" + endDate + "]";
	}
}
