  ...
  \${hoUser } : ${hoUser }
    ...
    <div class="wrapper">
      ...
      <!-- 멘트 -->
		...
		<div class="center"> 1년간 10만원으로 아래 혜택을 누려보세요!</div>
      	<div class="mdiv">
		    <div>
		    ...
		    <div>
		        <img src="https://i.ibb.co/yncH4L2/24.png" alt="병원홍보" border="0">
		        <p>병원홍보</p>
		    </div>
		    <div>
		        <img src="https://i.ibb.co/Fm1MWNR/55.png" alt="예약관리" border="0">
		        <p>예약관리</p>
		    </div>
		</div>
